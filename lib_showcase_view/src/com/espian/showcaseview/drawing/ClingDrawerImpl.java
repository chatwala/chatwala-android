...
public class ClingDrawerImpl implements ClingDrawer {
    ...
    public ClingDrawerImpl(Resources resources, int showcaseColor) {
        ...
        mShowcaseDrawable = resources.getDrawable(R.drawable.cling_bleached_test);
    ...
    public boolean calculateShowcaseRect(float x, float y) {
        ...
        mShowcaseRect.left = cx - dw;
        mShowcaseRect.top = cy - dh;
        mShowcaseRect.right = cx + dw;
        mShowcaseRect.bottom = cy + dh;
