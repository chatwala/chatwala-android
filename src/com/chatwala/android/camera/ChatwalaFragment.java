...
import com.chatwala.android.util.Typefaces;
...
public abstract class ChatwalaFragment extends Fragment {
    ...
    private boolean shouldShowPreview = AppPrefs.shouldShowPreview();
    ...
    protected boolean wasBackButtonPressed() {
    ...
    protected TextView generateCwTextView(String text, int backgroundColor, int margin) {
        ...
        tv.setTypeface(Typefaces.getMdTypeface(getApp()));
    ...
    public void post(Runnable r) {
        getCwActivity().post(r);
    }

    public void postDelayed(Runnable r, long delay) {
        getCwActivity().postDelayed(r, delay);
    }
}
